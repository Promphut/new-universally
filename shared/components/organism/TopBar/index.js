...
class TopBar extends React.Component {
  ...
  render() {
    ...
    let status = this.props.status || 'UNLOGGEDIN',
      { scrolling, user, menu, transparent, editButton, hasCover, canEditStory } = this.props;
    ...
    return (
      <Wrapper scroll={scroll}>
        <Container
          ...
          className={`menu-font ${!scrolling && transparent && hasCover ? 'transparent' : ''}`}
        >
          <Left>
            <HamburgerWrapper onClick={() => this.openPop('left')}>
              <Hamburger
                className="material-icons"
                style={!scrolling && transparent && hasCover ? { color: 'white' } : {}}
              >
                menu
              </Hamburger>
            </HamburgerWrapper>
            ...
            <Right>
              ...
              {this.role &&
                ...
                <Edit
                  ...
                  style={{
                    color: (!scrolling && transparent && hasCover) || theme.barTone != 'light'
                      ? '#FFF'
                      : '#222',
                  }}
                  to={editButton}
