...
const TopNavigation = ({ menu, children }) => {
  ...
  _.remove(cols, col => col.slug == 'news' || _.indexOf(children, col.slug) !== -1);
  ...
  return (
    <Container>
      <NavLink2 exact to="/stories/news" activeClassName="active" className="nunito-font">
        News
      </NavLink2>
      ...
      <NavLink2 exact to="/about" activeClassName="active" className="nunito-font">
        About Us
      </NavLink2>
      <NavLink2 exact to="/contact" activeClassName="active" className="nunito-font">
        Contact
      </NavLink2>
    </Container>
  );
