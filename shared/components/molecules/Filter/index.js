  ...
  render() {
    ...
    return (
      <AutoCompleteBox style={{ ...style }} className={className}>
        ...
        >
          <div style={{ position: 'relative', top: '-3px' }}>
            ...
            <FontIcon
              ...
              style={{ fontSize: '20px', color: '#8f8f8f', float: 'right', top: '8px' }}
            >
              keyboard_arrow_down
            </FontIcon>
          </div>
        ...
        <div style={{ width: '1px', height: '30px', background: '#e2e2e2', margin: '0 5px' }} />
        <IconButton
          style={{ width: '30px', height: '30px', padding: '0px' }}
          iconStyle={{ color: '#8f8f8f' }}
          onClick={this.props.search}
        >
          <FontIcon className="material-icons" style={{ fontSize: '20px', color: '#8f8f8f' }}>
            search
          </FontIcon>
        </IconButton>
      </AutoCompleteBox>
