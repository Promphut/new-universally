...
export default class ImageShare extends React.Component {
  ...
  handleMouse = () => {
    ...
    this.setState(
      ...
      () => {
        var eventList = [].forEach.call(this.state.imgContainer, (e) => {
          e.addEventListener('mouseenter', (e) => {
            self.hadleMouseEnter(e);
          });
        });
        var eventList2 = [].forEach.call(this.state.imgContainer, (e) => {
    ...
    return (
      ...
      >
        <SocialItemContainer>
          <FbShareButton
            button={
              <SocialItem target="_blank" BGColor={'#38559c'} BGDarkColor={'#052269'} order={'1'}>
        ...
        <SocialItemContainer>
          <TwtShareButton
            button={
              <SocialItem target="_blank" BGColor={'#35a9e0'} BGDarkColor={'#0276AD'} order={'2'}>
