  ...
  return (
    <Wrapper className={`${className} row`} style={{ ...style }}>
      <FlatButton
        ...
        label="STORIES"
        onClick={() => history.push('/stories/columns')}
      ...
      {page == 'allcolumn'
        ? ''
        : <FontIcon className="material-icons" style={chevronRightStyle}>
            chevron_right
          </FontIcon>}
      ...
      {!path
        ...
        : <FlatButton
          ...
          href={linkPath}
          icon={
            <FontIcon className="material-icons" style={{ fontSize: '35px', color: '#8f8f8f' }}>
                chevron_right
              </FontIcon>
            }
