        ...
        <Nav open={open}>
          <div className="menu menu-font">
            ...
            <CloseBtn onClick={close}>
              <FontIcon className="material-icons" style={{ color: '#222', fill: '#222' }}>
                close
              </FontIcon>
            </CloseBtn>
            ...
            <ul>
              ...
              <li>
                <Link style={linkStyle} to="/me/settings" onClick={close}>
                  {isMobile
                    ? <FontIcon style={{ paddingRight: '25px' }} className="material-icons">
                        account_circle
                      </FontIcon>
                    : ''}
                  Edit Profile
            ...
            <ul>
              <li>
                <Link style={linkStyle} to="/me/settings/account" onClick={close}>
                  {isMobile
                    ? <FontIcon style={{ paddingRight: '25px' }} className="material-icons">
                        settings
                      </FontIcon>
