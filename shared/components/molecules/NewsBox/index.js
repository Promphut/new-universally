...
const NewsBox = ({ detail, style, timeline, final }) => {
  ...
  return (
    <Container style={{ ...style }}>
      <Time className="hidden-mob" style={{ display: timeline ? 'block' : 'none' }}>
      ...
      <Box hr={final}>
        ...
        <Time className="hidden-des" style={{ display: timeline ? 'block' : 'none' }}>
          {utils.dateFormat(published)}
        </Time>
        <BG
          height={(screen.width - 32) / 1.91}
          url={url}
        ...
        <BoxText>
          ...
          <NameLink to={url} className="nunito-font">
            {truncate(ptitle, {
              length: 70,
              separator: '',
            })}
          </NameLink>
          <Desc className="nunito-font">
          ...
          <Desc className="nunito-font">
            ...
            {' '}
            <strong>
              <WriterLink to={writer && writer.url}>{writer && writer.display}</WriterLink>
            </strong>
          </Desc>
        </BoxText>
      </Box>
