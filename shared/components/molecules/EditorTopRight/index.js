...
import { PrimaryButton, EditorDropdown, ConfirmDialog } from '../../../components';
...
class EditorTopRight extends React.Component {
  ...
  publishStory = () => {
    ...
    if (story.format === 'NEWS') {
      ...
      if (story.column === newsCol || (story.column && story.column._id === newsCol)) { story.column = null; }
      story.contentType = story.contentType !== 'OTHER' ? story.contentType : null;
    }
    ...
    return (
      <Container>
        ...
        {mode === 'editor'
          ...
          : platform === 'desktop'
              ? <Block>
                <PrimaryButton label="Desktop" labelStyle={labelStyle} style={platformStyle} />
              ...
              : <Block>
                ...
                <PrimaryButton label="Mobile" labelStyle={labelStyle} style={platformStyle} />
              </Block>}
        <Line />
        ...
        {mode === 'editor'
          ? <Block>
            ...
            />
            <EditorDropdown unpublishStory={this.unpublishStory} deleteStory={this.openDialog} />
          </Block>
          : <Block>
            <RaisedButton
