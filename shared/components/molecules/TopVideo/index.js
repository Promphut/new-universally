        ...
        >
          <MiniBoxDark>
            ...
            <div style={{ width: '174px', margin: '0 0 0 20px' }}>
              ...
              <SName hover={hover} to={'#'} className="nunito-font">
                “เน็ตมือถือไม่พอใช้” ปัญหาใหญ่ของผู้ใช้ สมาร์ทโฟนชาวไทยในยุคนี้
              </SName>
            </div>
          </MiniBoxDark>
          <MiniBox
          ...
          >
            <Gra hover={hover}>
              <IC hover={hover}>
                <FontIcon className="material-icons" style={{ color: 'white', fontSize: '60px' }}>
                  play_circle_outline
                </FontIcon>
              </IC>
            </Gra>
